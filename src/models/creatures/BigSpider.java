 ...
 * @see Creature
 */
public class BigSpider extends Creature
{
	 ...
	 */
	public BigSpider(long santeMax, int nbPiecesDOr, double vitesse)
	{
	 ...
	 * @param vitesse vitesse de la creature
	 */
	public BigSpider(int x, int y, long santeMax, int nbPiecesDOr, double vitesse)
	{
	...
	{
		return new BigSpider(x,y,getSanteMax(),getNbPiecesDOr(),getVitesseNormale());
	}
}
