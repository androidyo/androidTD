...
public class Eagle extends Creature
{
	 ...
	 */
	public Eagle(long santeMax, int nbPiecesDOr, double vitesse)
	{
	 ...
	 * @param vitesse vitesse de la creature
	 */
	public Eagle(int x, int y, long santeMax, int nbPiecesDOr, double vitesse)
	{
	...
	{
		return new Eagle(x,y,getSanteMax(),getNbPiecesDOr(),getVitesseNormale());
	}
}
