...
public class BlackSheep extends Creature
{
	 ...
	 */
	public BlackSheep(long santeMax, int nbPiecesDOr, double vitesse)
	{
	 ...
	 * @param vitesse vitesse de la creature
	 */
	public BlackSheep(int x, int y, long santeMax, int nbPiecesDOr, double vitesse)
	{
	...
	{
		return new BlackSheep(x,y,getSanteMax(),getNbPiecesDOr(),getVitesseNormale());
	}
}
