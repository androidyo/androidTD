...
public class Sheep extends Creature
{
	 ...
	 */
	public Sheep(long santeMax, int nbPiecesDOr, double vitesse)
	{
	 ...
	 * @param vitesse vitesse de la creature
	 */
	public Sheep(int x, int y, long santeMax, int nbPiecesDOr, double vitesse)
	{
	...
	{
		return new Sheep(x,y,getSanteMax(),getNbPiecesDOr(),getVitesseNormale());
	}
}
