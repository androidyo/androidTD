...
public class Spider extends Creature
{
	 ...
	 */
	public Spider(long santeMax, int nbPiecesDOr, double vitesse)
	{
	 ...
	 * @param vitesse vitesse de la creature
	 */
	public Spider(int x, int y, long santeMax, int nbPiecesDOr, double vitesse)
	{
	...
	{
		return new Spider(x,y,getSanteMax(),getNbPiecesDOr(),getVitesseNormale());
	}
