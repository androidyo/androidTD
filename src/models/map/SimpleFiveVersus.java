...
public class SimpleFiveVersus extends Field
{
    ...
    public SimpleFiveVersus (Game jeu) 
    {
        ...
        e1.ajouterEmplacementJoueur(new PlayerLocation(1,new Rectangle(20,0,80,500),Color.RED));
        equipes.add(e1);
        ...
        e2.ajouterEmplacementJoueur(new PlayerLocation(2,new Rectangle(120,0,80,500),Color.BLUE));
        equipes.add(e2);
        ...
        e3.ajouterEmplacementJoueur(new PlayerLocation(3,new Rectangle(220,0,80,500),Color.GREEN));
        equipes.add(e3);
        ...
        e4.ajouterEmplacementJoueur(new PlayerLocation(4,new Rectangle(320,0,80,500),Color.YELLOW));
        equipes.add(e4);
        ...
        e5.ajouterEmplacementJoueur(new PlayerLocation(5,new Rectangle(420,0,80,500),Color.BLACK));
        equipes.add(e5);
