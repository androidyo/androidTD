...
public class Cloud extends Animation
{
	 ...
	 */
	public Cloud(Game jeu)
	{
		super(Tools.tirerNombrePseudoAleatoire(-500,-300), Tools.tirerNombrePseudoAleatoire(-100, jeu.getTerrain().getHauteur()));
	    
		IMAGE = IMAGES[Tools.tirerNombrePseudoAleatoire(0, 2)];
		vitesse = Tools.tirerNombrePseudoAleatoire(2, 10) / 100.0;
